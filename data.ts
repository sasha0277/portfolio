...
export const projects: IProject[] = [
  ...
  {
    id: 4,
    name: 'Wave Effect Small JavaScriptProject2',
    description: 'Wave Effect Login Form',
    image_path: '/images/waveEffect.png',
    deployed_url: 'https://keen-dolphin-c2c50d.netlify.app/',
    github_url: 'https://github.com/sonny-sharma',
    category: ['javascript'],
    key_tech: ['javascript'],
  },
